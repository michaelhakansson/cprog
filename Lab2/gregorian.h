...
namespace lab2 {
	...
	protected:
		...
		/**
		 * Calculates the julian day number of a gregorian date.
		...
		/**
		 * Calculates the year, month and day in a gregorian calendar
		 * given a julian day number.
		 * @param jdn A long representing the julian day number
		 * @param yy A pointer to an int that will be set to the year in a gregorian calendar
		 * @param mm A pointer to an int that will be set to the month in a gregorian calendar
		 * @param dd A pointer to an int that will be set to the day in a gregorian calendar
		 */
		virtual void jdn_to_ymd(long jdn, int *yy, int *mm, int *dd) const;
	
	public:
		/**
	 	* Default constructor for a gregorian date. Uses todays date.
	 	*/
		Gregorian();
		...
		/**
		 * Copy construct a gregorian date from another Date object.
		...
		/**
		 * Getter for the year
		 * @return An int representing the year in a gregorian calendar
		 */
		virtual int year() const;

		/**
		 * Getter for the month
		 * @return An int representing the month in a gregorian calendar
		 */		
		virtual int month() const;

		/**
		 * Getter for the day
		 * @return An int representing the day in a gregorian calendar
		 */
		...
		/**
		 * Getter for days per week in a gregorian calendar.
		 * @return An int representing the number of days per week.
		 * As long as no one makes radical changes to the gregorian
		 * calendar, this will always be 7.
		 */
		virtual int days_per_week() const;

		/**
		 * Getter for months per year in a gregorian calendar.
